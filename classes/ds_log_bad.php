...
class ds_log_bad extends be_module {
	public function process( $ip, &$stats = array(), &$options = array(), &$post = array() ) {
		...
		do_action( 'ds_caught', $ip, $post ); // post has the chk and reason in the array plus all the other info
		be_load( 'ds_challenge', $ip, $stats, $options, $post );
		exit();
	}
}
